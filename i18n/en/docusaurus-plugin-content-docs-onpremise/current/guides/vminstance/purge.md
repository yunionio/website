...
:::tip
Since this operation is relatively complex and not commonly used, it only supports climc command line operations
:::

Using virtual machine ID a77d4f36-5484-47d9-8f12-26c7f0dd48f3 as an example

### 1. Find Virtual Machine's Host ID
...
### 2. Disable Host Where Virtual Machine is Located
...
### 3. Disable Virtual Machine Delete Protection
...
### 4. Clear Virtual Machine Database Record
