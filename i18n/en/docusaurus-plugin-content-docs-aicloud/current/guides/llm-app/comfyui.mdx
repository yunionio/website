...
Image generation depends on a GPU environment. Please first complete [Configure NVIDIA and CUDA Environment](/docs/aicloud/getting-started/setup-nvidia-cuda).
