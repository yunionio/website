...
- Read in this order: [AI Applications](./llm-app/) (including [Application Templates](./llm-app/template)) → [AI Inference](./llm-inference/) (including [Inference Templates](./llm-inference/template) / [Model Files](./llm-inference/model-library) / [Inference Images](./llm-inference/image), and optionally [Accelerator Scenarios](./llm-inference/gpu-scenarios/) such as [Run DeepSeek V4 Flash on Huawei Ascend NPU](./llm-inference/gpu-scenarios/ascend-deepseek-v4-flash)).
...
- **Applications**: Application instances (Dify/OpenClaw/HermesAgent/ComfyUI), application templates.
