...
- About GPU
  ...
  - If there is no Nvidia GPU, the deployed environment will not be able to run inference container instances like vLLM or SGLang, but it can run application container instances like OpenClaw and Dify that do not depend on GPU.
...
To install or configure NVIDIA drivers and CUDA on a node to run GPU-dependent AI container applications such as vLLM and SGLang, please refer to: [Setting up NVIDIA and CUDA Environment](./setup-nvidia-cuda).
...
|---|---|---|---|---|
| OpenClaw | AI App | Open-source self-hosted personal agent assistant | No | [OpenClaw Quick Start](../guides/llm-app/instance/openclaw#quickstart) |
| HermesAgent | AI App | Open-source autonomous agent from Nous Research | No | [HermesAgent Quick Start](../guides/llm-app/instance/hermes#quickstart) |
| Dify | AI App | LLM application development and workflow orchestration platform (can connect to inference services) | No | [Dify Quick Start](../guides/llm-app/instance/dify#quickstart) |
| ComfyUI | AI App | Image generation and node-based workflow application | Yes | [ComfyUI Quick Start](../guides/llm-app/instance/comfyui#quickstart) |
| vLLM / SGLang | AI Inference | Inference services deployed by template type | Yes | [AI Inference Quick Start](../guides/llm-inference/quickstart) |
