...
Released at 2021-07-02 19:23:36
...
48 commits to [cloudpods - v3.6.19](https://github.com/yunionio/cloudpods/compare/v3.6.18...v3.6.19) since this release.
...
3 commits to [cloudpods-operator - v3.6.19](https://github.com/yunionio/cloudpods-operator/compare/v3.6.18...v3.6.19) since this release.
...
1 commits to [ocadm - v3.6.19](https://github.com/yunionio/ocadm/compare/v3.6.18...v3.6.19) since this release.
...
- **calico,k8s,ovn:** 部置calico-node时调整默认配置提升ovn隧道流量的性能 ([85383f53](https://github.com/yunionio/ocadm/commit/85383f5332568967d0aa1a0f618cff70594c00dd), [Zhang Dongliang](mailto:zhangdongliang@yunion.cn))
 ...
 v3.6.19]: https://github.com/yunionio/ocadm/compare/v3.6.18...v3.6.19
