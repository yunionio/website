...
|---|---|---|---|---|
| OpenClaw | AI应用 | 开源自托管的个人智能体助手 | 不需要 | [OpenClaw 快速开始](../guides/llm/openclaw#quickstart) |
| Dify | AI应用 | LLM 应用开发与工作流编排平台（可对接推理服务） | 不需要 | [Dify 快速开始](../guides/llm/dify#quickstart) |
| ComfyUI | AI应用 | 图像生成与节点式工作流应用 | 需要 | [ComfyUI 快速开始](../guides/llm/comfyui#quickstart) |
| Ollama | AI推理 | 轻量本地推理服务 | 需要 | [Ollama 快速开始](../guides/llm/ollama#quickstart) |
| vLLM | AI推理 | 高吞吐、低延迟推理服务 | 需要 | [vLLM 快速开始](../guides/llm/vllm#quickstart) |
