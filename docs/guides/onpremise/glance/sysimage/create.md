...
推荐使用 [packer](https://www.packer.io/intro/getting-started/install.html) 这个工具来自动化制作镜像，详细操作可以参考对应的文档: [https://www.packer.io/docs/index.html](https://www.packer.io/docs/index.html) 。


[https://github.com/yunionio/service-images](https://github.com/yunionio/service-images) 仓库包含了一些我们使用 packer 制作镜像的配置，可以参考使用。
